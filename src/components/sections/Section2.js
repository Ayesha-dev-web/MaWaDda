            ...
            <div className="max-w-6xl w-full flex flex-col md:flex-row items-center justify-between gap-12 px-6">
                ...
                <div className="md:w-1/2 flex flex-col items-center md:items-start text-center md:text-left">
                    ...
                    <p className="text-gray-700 mt-4 max-w-lg">
                       Inspired by the Islamic values of love, mercy, and compassion, Mawaddah is dedicated to supporting individuals and families through every stage of life. As qualified marriage celebrants and counsellors, we serve the community by conducting Nikah (Islamic marriage ceremonies), offering faith-based marriage counselling, and helping couples resolve conflicts through Sharia-compliant arbitration.
                    </p>
